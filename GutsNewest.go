...
//assignmentName, start/end date, runtime

func editCourse(courseName string, title string, startDate string, endDate string) {
	...
	res, err := db.Exec("update CourseDescription set CourseDisplayName=?, StartDate=?, EndDate=? where CourseName=?", title, startDate+" 23:59:59", endDate+" 23:59:59", courseName)
...
func main() {
	...
	//editCourseDescription("TerwilligerCS15501SP17", "This is a description")
	//editCourse("TerwilligerCS15501SP17", "CS 155", "2017-3-10-4", "2017-4-5")
	gradeAssignment(10007, "TerwilligerCS15501SP17", "Assignment 1", 1, 30)
}
